...
export class SimpleServer {
  ...
  private simulateServerUpdates() {
    ...
    if (Math.random() < 0.1 && serverData.length > 0) {
      const pendingReports = serverData.filter(
